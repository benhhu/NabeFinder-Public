...
function sizeLayerControl() {
  //$(".leaflet-control-layers").css("max-height", 
    $("#map").height() - 50);
}
*/
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "../static/img/theater.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      ...
      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="../static/img/theater.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      theaterSearch.push({
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='../static/img/theater.png' width='24' height='28'>&nbsp;Theaters": theaterLayer,
    "<img src='../static/img/museum.png' width='24' height='28'>&nbsp;Museums": museumLayer
  },
  "Reference": {
    "Boroughs": boroughs,
...
/*
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='../static/img/theater.png' width='24' height='28'>&nbsp;Theaters</h4>",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='../static/img/museum.png' width='24' height='28'>&nbsp;Museums</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
